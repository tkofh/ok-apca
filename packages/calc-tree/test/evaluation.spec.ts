...
import { constant } from '../src/expression.ts'
...
describe('evaluation', () => {
	...
	describe('css output', () => {
		...
		it('constant expression serializes to the value', () => {
			...
			expect(Calc.serialize(expr)).toBe('42')
		})
	})
	...
	describe('simplification', () => {
		...
		it('simplifies nested constants', () => {
			const expr = Calc.add(Calc.multiply(2, 3), Calc.add(4, 5))
			const result = Calc.solve(expr)
